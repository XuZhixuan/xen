...
const struct iommu_ops *iommu_get_ops(void) { return iommu_ops; }
...
int arch_iommu_domain_init(struct domain *d) { return iommu_dt_domain_init(d); }
 ...
 */
bool arch_iommu_use_permitted(const struct domain *d) { return true; }
